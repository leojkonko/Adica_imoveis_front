...
<body>
    ...
    <header class="header w-100  isolation-isolate position-absolute w-100 top-0 start-0 w-100 py-2 py-lg-2 px-2 px-lg-0 {{ !Route::is('home') ? "bg-primary position-relative" : "" }}" data-aos="zoom-out-up">
        <div class="container">
                ...
                {{--<div class="col-lg-7 col-6 me-auto m-lg-auto d-flex justify-content-end justify-content-lg-center">
                    ...
                    <div class="col-lg-6 col-6 ms-auto d-flex align-items-center justify-content-end">
                        <div class="d-flex gap-1">
                            <button class="btn btn-outline-orange rounded-5 d-none d-md-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                                Busca avançada
                            ...
                            <button class="ms-1 btn btn-outline-orange rounded-5 text-white" style="padding: 14px;" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
        ...
        <svg class="position-absolute w-100 start-0 bottom-0" width="1920" height="2" viewBox="0 0 1920 2" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 1H1920" stroke="white" stroke-opacity="0.5"/>
        </svg>            
    </header>
